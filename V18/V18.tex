...
Germaniumdetektor:$\approx \SI{500}{\kilo\eV} $)
...
\begin{figure}
  \centering
  \includegraphics[scale=0.8]{Wechselwirkungen.jpeg}
...
Als Maß hierfür ist die Halbwertsbreite des Photopeaks angegeben (bei
monochromatischer $\gamma$-Strahlung). Diese ist vor allem abhängig von der
Anzahl der erzeugten Elektronenlochpaare.
